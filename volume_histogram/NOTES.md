...
## Test 6
```
int histogram[] = { 0, 10, 0, 0, 0, 5, 0, 0, 0, 6, 0, 0, 8, 0, 0, 0, 0, 9, 0, 0,
                    0,  2, 0, 0, 0, 7, 0, 0, 0, 6, 0, 0, 0, 9, 0, 0, 0, 4, 0, 0,
                    0,  3, 0, 0, 5, 0, 0, 0, 4, 0, 0, 7, 0, 0, 2, 1, 0 };
int size = 57;
```
correct return = 343
```
...
## Test 7
```
int histogram[] = { 2, 0, 0, 5, 6, 6, 5, 0, 0, 8, 9, 0, 5, 0, 0, 4, 0, 7, 0, 8,
                    0, 9, 0, 3, 0, 1, 0, 5, 0, 5, 0, 6, 0, 4, 0, 6, 0, 7, 0, 5,
                    5, 6, 5, 4, 7, 0, 8, 0, 5, 0, 0, 0 };
int size = 52;
```
correct return = 211
```
